...
// ── Navigation ────────────────────────────────────────────────────────────────
export type SectionId = 'inicio' | 'noc' | 'red' | 'academia' | 'wfm' | 'call' | 'scan' | 'gerencia' | 'reports' | 'reportlab' | 'reportes-kpi' | 'tokens' | 'transacciones' | 'etiquetas' | 'editor' | 'holo' | 'foda' | 'bridge' | 'war-room' | 'incidentes' | 'mobile' | 'telegram' | 'docs' | 'adopcion' | 'bidrillas' | 'agentes' | 'rrhh' | 'sala_juntas' | 'inv-transfers' | 'merkle' | 'ventas' | 'ventas-efectividad' | 'estrategia2030' | 'superadmin' | 'cerebro' | 'comite' | 'token-ai' | 'proyectos' | 'infra-energia' | 'backup' | 'impacto' | 'plan2026' | 'integridad' | 'analytics' | 'helpdesk' | 'net2phone' | 'fibra' | 'radiobases' | 'auditoria-odoo' | 'auditorias-plazas' | 'iblack' | 'odoo-docs' | 'blackstone' | 'city-mty' | 'city-slt' | 'usuarios-admin' | 'usuarios-invitados' | 'atc-efectividad' | 'cast' | 'sync' | 'fibra_xcien' | 'mesa-ops' | 'flotilla' | 'backlog';
